...
int main() {
	...
	entries.reserve(3);
	entries.emplace_back(Student("Михалков", "Иван", "Олегович", 21, 3, "КСМО-01-19"));
	entries.emplace_back(Student("Петров", "Валерий", "Михайлович", 18, 1, "КСМО-01-21"));
	entries.emplace_back(Student("Базанов", "Семен", "Дмитриевич", 45, -156, "КСМО-01-19"));
	printEntries(entries);
